...
Dir.foreach(folder) do |file|
	...
	if (supported_extensions.include?(extension))
		...
		output_folder = folder + File.basename(file, ".*" ) + "-Foreground/"
		...
		algo_command = algo_path + ' -CA "' + xml_path + '" "' + contour_path + '" ' + flip_switch + ' "' + first_image_path + '" -bmp -r' + frame_rate + ' "' + output_path + '"'
		puts "*** Running Algo *** \n" + algo_command 
